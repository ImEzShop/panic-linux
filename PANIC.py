try:
    ...
    os.system('title PANIC RAIDER - Installing dependencies')
    i = 0
    imports = [
        'requests', 
        'colorama', 
...
class Render:
    ...
    def render_ascii(self):
        os.system('cls')
        os.system(f"title PANIC RAIDER - guns.lol/solve - .gg/haxxor    ")
        edges = ["╗", "║", "╚", "╝", "═", "╔"]
        title = f"""
{'██████╗  █████╗ ███╗   ██╗██╗ ██████╗'.center(self.size)}
{'██╔══██╗██╔══██╗████╗  ██║██║██╔════╝'.center(self.size)}
...
"""
    ...
    def raider_options(self):
        ...
        with open("data/tokens.txt", "r") as f:
            tokens = f.read().splitlines()
        edges = ["─", "╭", "│", "╰", "╯", "╮", "»", "«"] 
        title = f"""{' '*39}{Fore.RESET} Loaded ‹{Fore.LIGHTCYAN_EX}{len(tokens)}{Fore.RESET}› tokens | Loaded ‹{Fore.LIGHTCYAN_EX}{len(proxies)}{Fore.RESET}> proxies
...
{'│ «05» Emoji Reaction    «10» Friend Spam        «15» Typer             «20» solve            │'.center(self.size)}
{'╰─────────────────────────────────────────────────────────────────────────────────────────────╯'.center(self.size)}
"""
        for edge in edges:
            title = title.replace(edge, f"{self.background}{edge}{C['white']}")
...
class Menu:
    ...
    @solve
    def soundbord(self):
        os.system('title PANIC RAIDER - Soundboard Spam')
    ...
    @solve
    def friender(self):
        os.system('title PANIC RAIDER - Friender')
    ...
    @solve
    def caller(self):
        os.system('title PANIC RAIDER - Caller')
    ...
    def onliner(self):
        os.system('title PANIC RAIDER - Onliner')
        args = [
    ...
    @solve
    def typier(self):
        os.system('title PANIC RAIDER - Typer')
    ...
    def nick_changer(self):
        os.system('title PANIC RAIDER - Nickname Changer')
    ...
    def voice_joiner(self):
        os.system('title PANIC RAIDER - Voice Joiner')
        Link = input(console.prompt("Channel LINK"))
        if Link == "":
            Menu().main_menu()
        if Link.startswith("https://"):
    ...
    def Thread_Spammer(self):
        os.system('title PANIC RAIDER - Thread Spammer')
    ...
    @solve
    def joiner(self):
        os.system('title Blue Krakeb - Joiner')
    ...
    @solve 
    def leaver(self):
        os.system('title PANIC RAIDER - Leaver')
        guild = input(console.prompt("Guild ID"))
        if guild == "":
            Menu().main_menu()
        os.system('cls')
    ...
    @solve
    def spammer(self):
        os.system('title PANIC RAIDER - Spammer')
        with open("data/tokens.txt", "r") as f:
            tokens = f.read().splitlines()
        Link = input(console.prompt(f"Channel LINK"))
        if Link == "":
    ...
    def checker(self):
        os.system('title PANIC RAIDER - Checker')
        self.raider.token_checker()

    @solve
    def reactor(self):
        os.system('title PANIC RAIDER - Reactor')
    ...
    def formatter(self):
        os.system('title PANIC RAIDER - Formatter')
        self.run(self.raider.format_tokens, [()])
    
    @solve
    def button(self):
        os.system('title PANIC RAIDER - Clicker')
    ...
    @solve
    def accept(self):
        os.system('title PANIC RAIDER - Accept Rules')
    ...
    @solve
    def guild(self):
        os.system('title PANIC RAIDER - Guild Checker')
        guild_id = input(console.prompt("Guild ID"))
        if guild_id == "":
            Menu().main_menu()
        os.system('cls')
    ...
    def bio_changer(self):
        os.system('title PANIC RAIDER - Bio Changer')
    ...
    @solve
    def onboard(self):
        os.system('title PANIC RAIDER - Onboarding Bypass')
        guild_id = input(console.prompt("Guild ID"))
        if guild_id == "":
            Menu().main_menu()
        os.system('cls')
    ...
    @solve
    def solve(self):
        os.system('title PANIC RAIDER - Solve (Contact)')
        print("\033[1;36mDeveloper: solve (@imsolve)\n\033[1;35mDiscord: .gg/haxxor\n\033[1;32mGitHub: GitHub.com/imsolve\n\033[1;34mTelegram: t.me/imsolve\033[0m")
        input("\n\n                                        \033[1;33m         Press Enter To Return")
        os.system('cls')
        Menu().main_menu()
        console.render_ascii() 
